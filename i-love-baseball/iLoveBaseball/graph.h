...
private:
    ...
    **********************/
    ...
    std::vector<std::string> dreamPath;   // IN - vec of shortest dream path
    std::vector<std::string> majorPath;   // IN - vec of shortest major path
    std::vector<std::string> nPath;       // IN - vec of shortest national
    std::vector<std::string> aPath;       // IN - vec of shortest american
public:
    /*****************
    ** CONSTRUCTOR **
    *****************/
    ...
    *****************/
    ...
    int dream(std::vector<std::string> places);
    int national(int start);
    int american(int start);
    int major(int start);
    ...
    void read_stadiums();
    void read_distances();
    std::vector<std::string> getDream() { return dreamPath; }
    std::vector<std::string> getNational() { return nPath; }
    std::vector<std::string> getAmerican() { return aPath; }
    std::vector<std::string> getMajor() { return majorPath; }
